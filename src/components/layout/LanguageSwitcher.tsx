...
export const LanguageSwitcher: React.FC<LanguageSwitcherProps> = ({ appLocale, onLocaleChange }) => {
  ...
  return (
    <div className="relative hidden xl:block" ref={containerRef} data-language-switcher="desktop">
      <button
        type="button"
