...
export const WinRateGraph: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            {/* Labels */}
            <div className="absolute top-1 left-1 text-[9px] ui-text-faint pointer-events-none">100%</div>
            <div className="absolute bottom-1 left-1 text-[9px] ui-text-faint pointer-events-none">0%</div>
